...
export default function MnemonicGenerate({setMnemonic}:{setMnemonic:Function}){
    ...
    return(
        <div className="flex justify-between text-xl">
            ...
            <input className="text-center m-4 p-4 max-w-full bg-slate-400 w-1/2 placeholder-slate-100 rounded-t-full"  type="text" value={mnemonics} onChange={(e) => setMnemonics(e.target.value)} placeholder="Enter or Generate your Mnemonic Phrase here" />
